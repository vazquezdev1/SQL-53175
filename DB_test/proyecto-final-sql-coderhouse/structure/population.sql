...
load data local infile './structure/data_csv/2. clients_data.csv'
into table clients
...
load data local infile './structure/data_csv/4. kiosks_data.csv'
into table kiosks
fields terminated by ','
optionally enclosed by '"'
lines terminated by '\r\n'
...
load data local infile './structure/data_csv/5. employees_data.csv'
...
load data local infile './structure/data_csv/7. products_data.csv'
into table products
fields terminated by ','
optionally enclosed by '"'
lines terminated by '\r\n'
...
load data local infile './structure/data_csv/8. bills_data.csv'
into table bills
fields terminated by ','
optionally enclosed by '"'
lines terminated by '\r\n'
